...
const items = [
  ...
  },
  {
    ...
    description:
      "Plant Daddy reminds you when water is needed, how much and much more!",
    image: (
      <Image
        style={{
          padding: 0,
        ...
        <ScrollView
          ...
          onScroll={(data) => {
            const newActive = Math.round(
              data.nativeEvent.contentOffset.x / WindowWidth
            );
            setActive(newActive);
          }}
        >
          ...
          {items.map((_, i) => (
            <View
              ...
              style={{
                ...
                width: active === i ? 16 : 8,
                backgroundColor:
                  active === i ? colors.green.light : colors.gray.primary,
                marginHorizontal: 4,
                marginVertical: 16,
                borderRadius: 4,
              }}
